...
def problem4(emis=0.708, lam=25.):
    ...
    ax.set_xlabel(r"Insolation Multiplier γ ${\bullet} 1370 W/m^2$")
    ax.set_ylabel(r"Latitude ($^{\circ}$)")
    fig.suptitle("Latitudinal temperature distribution by Insolation; Initial condition generated by previous γ step")
